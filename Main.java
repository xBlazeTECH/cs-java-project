...
class Main {
  public static void main(String[] args) {
    ...
    Item thornySword = new Item("Thorny Sword", 1000, 15); // Add Power Parameter
    Item goldenSword = new Item("Golden Sword", 1500, 20); // Add Power Parameter
    Item SwordofWrath = new Item("Sword of Wrath", 10000, 25); // Add Power Parameter
